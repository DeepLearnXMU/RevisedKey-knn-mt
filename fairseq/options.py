...
def add_datastore_args(parser):
    ...
    group.add_argument("--retrieve-adapter", default=False, action='store_true')
    group.add_argument("--use-retrieve-adapter", default=None, type=str)
    group.add_argument("--adapter-ffn-scale", default=4, type=int)
